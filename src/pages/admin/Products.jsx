            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="text-xs font-bold text-gray-400 uppercase">
                  ...
                  {imagePreviews.length > 0 && (
                    <span className="ml-2 text-cyan-600 normal-case font-bold">
                ...
                <label className="mt-1 flex flex-col items-center justify-center w-full h-28 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:bg-gray-50 hover:border-cyan-400 transition-colors group">
                  <LuCloudUpload
                    size={28}
                    className="text-gray-300 group-hover:text-cyan-500 mb-2 transition-colors"
                  />
                  <span className="text-sm font-bold text-gray-400 group-hover:text-cyan-600 transition-colors">
                ...
                {imagePreviews.length > 0 && (
                  <div className="grid grid-cols-4 gap-2 mt-3">
                    {imagePreviews.map((preview, i) => (
                      <div
                        key={i}
                        className="relative w-full aspect-square rounded-xl overflow-hidden border border-gray-200 group/img"
                      >
                        <img
                          src={preview}
                          className="w-full h-full object-cover"
                        ...
                        {i === 0 && (
                          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent">
                            <p className="text-[8px] font-black text-white text-center pb-0.5 uppercase tracking-wider">
                              Cover
                            </p>
                          </div>
                        )}
              ...
              <div className="pt-4 flex gap-3">
                <button
                  type="button"
                  onClick={resetForm}
                  className="flex-1 py-3 rounded-xl border text-gray-600 font-bold hover:bg-gray-50 transition-all"
                >
                  Cancel
                </button>
                <button
      ...
      {deletingProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div
            ...
            onClick={() =>
              !deleteMutation.isPending && setDeletingProduct(null)
            }
          />
              ...
              <div className="flex items-center gap-3 bg-gray-50 rounded-2xl p-3 mb-6 border border-gray-100">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">
                    ₹{deletingProduct.price} · {deletingProduct.type}
                  </p>
                </div>
              </div>
