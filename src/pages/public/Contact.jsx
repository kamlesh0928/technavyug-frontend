...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await publicService.submitContactForm(form);
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-500 leading-relaxed">
              Have questions or need support? We are here to help you on your
              learning journey.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {contactInfo.map((item, i) => (
              <div
                key={i}
                className="p-6 rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all text-center"
              >
