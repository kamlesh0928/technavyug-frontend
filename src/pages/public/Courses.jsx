      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-slate-50 via-white to-cyan-50/30">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-2xl">
            <p className="text-xs font-bold text-cyan-600 uppercase tracking-widest mb-3">Explore & Learn</p>
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-4">
              Browse Courses
            </h1>
            <p className="text-gray-500 text-lg leading-relaxed">
              Find the perfect course to level up your skills and accelerate your career.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-10">
            ...
            <div className="relative">
              <LuFilter className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
              <select
                value={level}
              ...
              {courses.map((course) => (
                ...
                >
                  <div className="h-44 bg-gray-50 overflow-hidden">
                    <img
                      src={course.thumbnail || "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=800"}
                      alt={course.title}
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-xs text-gray-400 line-clamp-2 mb-4">{course.shortDescription}</p>
                    <div className="flex items-center justify-between text-xs text-gray-400">
                      <div className="flex items-center gap-3">
                        <span className="flex items-center gap-1"><LuClock size={12} /> {Math.round((course.totalDuration || 0) / 3600)}h</span>
                        <span className="flex items-center gap-1"><LuUsers size={12} /> {course.totalEnrollments}</span>
                      </div>
                      <span className="flex items-center gap-1 text-amber-500"><LuStar size={12} /> {course.averageRating || "N/A"}</span>
                    </div>
