...
function CourseForm({ course, categories, id }) {
  ...
  const [showCustomLanguage, setShowCustomLanguage] =
    useState(isCustomLangInitial);
  const [customLanguage, setCustomLanguage] = useState(
    isCustomLangInitial ? lang : "",
  );
    ...
    >
      ...
      <div className="flex items-center gap-4 mt-2">
        <button
          ...
          className="bg-[#0f2c59] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#1d4e89] transition-all disabled:opacity-60 flex items-center gap-2"
        >
          <LuSave size={16} />
        ...
        {form.status !== "Published" && (
          <button
            ...
            className="bg-green-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-green-700 transition-all disabled:opacity-60 flex items-center gap-2"
          >
            <LuCheck size={16} />
            Publish Course
          </button>
    ...
    <div className="space-y-4 max-w-3xl">
              ...
              {section.lectures?.map((l, lIndex) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      className={`w-7 h-7 rounded-lg flex items-center justify-center ${l.videoUrl ? "bg-cyan-50 text-cyan-500" : "bg-gray-100 text-gray-400"}`}
                    >
                      {l.videoUrl ? (
                        <LuVideo size={13} />
                      ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${l.videoUrl ? "text-green-600 bg-green-50" : "text-gray-400 bg-gray-100"}`}
                    >
                      {l.videoUrl ? (
                ...
                <div className="bg-gradient-to-br from-cyan-50/40 to-blue-50/40 border border-cyan-100/60 rounded-xl p-5 mt-3 space-y-4">
                  ...
                  <div>
                    ...
                    {lectureFile ? (
                      ...
                      <div
                        className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all ${isDraggingLecture ? "border-cyan-400 bg-cyan-50/30" : "border-gray-200 hover:border-cyan-300 hover:bg-gray-50/50"}`}
                        onDragOver={(e) => {
                          e.preventDefault();
      ...
      {showSectionInput ? (
        ...
        <button
          type="button"
          onClick={() => setShowSectionInput(true)}
          className="w-full py-4 border-2 border-dashed border-gray-200 rounded-2xl text-sm font-bold text-gray-500 hover:border-cyan-300 hover:text-cyan-600 hover:bg-cyan-50/30 transition-all flex items-center justify-center gap-2"
        >
    ...
    return (
      <div className="text-center py-20">
        ...
        <button
          ...
          className="text-cyan-600 font-bold mt-4"
        >
          Go Back
        </button>
      </div>
      ...
      <div className="max-w-2xl">
        {activeTab === "info" ? (
          ...
          <CourseCurriculum
            ...
            initialSections={
              courseData.data.Sections || courseData.data.sections || []
            }
          />
        )}
      </div>
