...
import { LuChevronLeft, LuChevronRight, LuShoppingCart, LuImage, LuPackage, LuZap } from "react-icons/lu";
...
export default function ProductCard({ product, onDetailClick, onAddToCart, onBuyNow }) {
