      ...
      <section className="py-12 bg-white border-b border-gray-100">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 text-center">
          ...
          <div className="flex justify-center items-center opacity-80 hover:opacity-100 transition-opacity">
            {/* Placeholder for the certificate/recognition image */}
            <img
              src="https://res.cloudinary.com/drhrgs6y5/image/upload/v1779286489/Startup_Recognition_DPIIT_Startupindia_TECHNAVYUG_PRIVATE_LIMITED_page-0001_w3ffxx.jpg"
              alt="Recognition Certificate"
              className="h-48 md:h-72 object-contain grayscale hover:grayscale-0 transition-all duration-500 rounded-lg shadow-sm"
            />
          </div>
        </div>
      </section>
